...
import com.example.KeyCloakExample.dto.UserDTO;
...
public class UserController {
    ...
    private String clientId = "ebank";
    private String role = "ebank-user";
    //Get client secret from the Keycloak admin console (in the credential tab)
    private String clientSecret = "001bbe77-451f-40d4-be88-246ebd0afb81";
